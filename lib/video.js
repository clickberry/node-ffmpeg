...
module.exports = function (filePath, settings, infoConfiguration, infoFile) {
	 ...
	 */
	this.fnExtractFrames = function (/* destinationFolder, settings, callback */) {
		...
		settings.format = (settings.format || 'jpg').toLowerCase();
		settings.file_name = path.basename(settings.file_name, path.extname(settings.file_name)) + '_%d.' + settings.format;
